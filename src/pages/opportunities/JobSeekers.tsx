        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-8 border border-white/10">
              ...
              <h3 className="text-2xl font-bold text-gray-100 mb-4">Personalized Matching</h3>
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-8 border border-white/10">
              ...
              <h3 className="text-2xl font-bold text-gray-100 mb-4">Interview Preparation</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-8 border border-white/10">
              ...
              <h3 className="text-2xl font-bold text-gray-100 mb-4">Salary Negotiation</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-8 border border-white/10">
              ...
              <h3 className="text-2xl font-bold text-gray-100 mb-4">Career Development</h3>
              <p className="text-gray-300 leading-relaxed">
